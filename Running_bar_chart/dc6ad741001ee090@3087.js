...
<div class="center-align">
  ...
  <p>
    This chart animates the value (in $M) of the top global brands from 2000 to 2019. Different colors indicate sectors. The animation of the top global brands' values from 2000 to 2019 highlights the dynamic nature of brand leadership and market competition. It shows how different sectors (indicated by color) have grown or declined over time, with some brands consistently leading while others rise or fall. The shifting values of top global brands highlight the competitive nature of the global market and the evolving leadership across different sectors.
  </p>
  <p>
    Data: <a href="https://www.interbrand.com/best-brands/" target="_blank">Interbrand</a>
  </p>
</div>
  `;
}
...
export default function define(runtime, observer) {
  ...
  main.define("n", _n);
  main.define("names", ["data"], _names);
  main.define("datevalues", ["d3","data"], _datevalues);
  main.define("rank", ["names","d3","n"], _rank);
  main.define("k", _k);
  main.define("keyframes", ["d3","datevalues","k","rank"], _keyframes);
  main.define("nameframes", ["d3","keyframes"], _nameframes);
  main.define("prev", ["nameframes","d3"], _prev);
  main.define("next", ["nameframes","d3"], _next);
  main.define("bars", ["n","color","y","x","prev","next"], _bars);
  main.define("labels", ["n","x","prev","y","next","textTween"], _labels);
  main.define("textTween", ["d3","formatNumber"], _textTween);
  main.define("formatNumber", ["d3"], _formatNumber);
  main.define("tickFormat", _tickFormat);
  main.define("axis", ["marginTop","d3","x","width","tickFormat","barSize","n","y"], _axis);
  main.define("ticker", ["barSize","width","marginTop","n","formatDate","keyframes"], _ticker);
  main.define("formatDate", ["d3"], _formatDate);
  main.define("color", ["d3","data"], _color);
  main.define("x", ["d3","marginLeft","width","marginRight"], _x);
  main.define("y", ["d3","n","marginTop","barSize"], _y);
  main.define("height", ["marginTop","barSize","n","marginBottom"], _height);
  main.define("barSize", _barSize);
